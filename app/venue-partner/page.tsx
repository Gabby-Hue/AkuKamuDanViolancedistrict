    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            required
            className="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm shadow-sm transition-colors focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 dark:focus:border-teal-500 dark:focus:ring-teal-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
      ...
      <div className="flex items-center">
        ...
        >
          ...
          <Link
            href="/terms"
            className="font-medium text-orange-600 hover:text-orange-500 dark:text-teal-300 dark:hover:text-teal-200"
          >
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <Link
                href="/auth/login"
                className="font-semibold text-orange-600 hover:text-orange-500 dark:text-teal-300 dark:hover:text-teal-200"
              >
