...
const sportsCategories: SportCategory[] = [
  {
    name: "Basket",
    href: `/explore?sport=${encodeURIComponent("Basket")}`,
    image: "/sports/basket.svg",
    accent: "rgba(255, 122, 31, 0.2)",
  },
  {
    name: "Voli",
    href: `/explore?sport=${encodeURIComponent("Voli")}`,
    image: "/sports/voli.svg",
    accent: "rgba(37, 99, 235, 0.2)",
  },
  {
    name: "Futsal",
    href: `/explore?sport=${encodeURIComponent("Futsal")}`,
    image: "/sports/futsal.svg",
    accent: "rgba(22, 163, 74, 0.2)",
  },
  {
    name: "Padel",
    href: `/explore?sport=${encodeURIComponent("Padel")}`,
    image: "/sports/padel.svg",
    accent: "rgba(6, 182, 212, 0.18)",
  },
  {
    name: "Badminton",
    href: `/explore?sport=${encodeURIComponent("Badminton")}`,
    image: "/sports/badminton.svg",
    accent: "rgba(139, 92, 246, 0.2)",
  },
  {
    name: "Tennis",
    href: `/explore?sport=${encodeURIComponent("Tennis")}`,
    image: "/sports/tennis.svg",
    accent: "rgba(34, 197, 94, 0.18)",
  },
  {
    name: "Sepak bola",
    href: `/explore?sport=${encodeURIComponent("Sepak bola")}`,
